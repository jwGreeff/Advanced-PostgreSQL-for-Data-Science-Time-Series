...
/*creates a table with partitions associated to it with data distributed 
between tables based on event_hour*/


CREATE TABLE time_series.loc_temp_p1 PARTITION OF time_series.location_temp_p
    FOR VALUES FROM (0) TO (2); --0 is inclusive 2 is exclusive in FROM clause
